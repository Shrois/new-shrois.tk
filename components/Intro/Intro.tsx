    ...
    >
      <div className="min-h-screen max-w-5xl mx-auto px-10 lg:px-20 py-24 md:py-28 lg:py-3 flex flex-col justify-center items-center text-4xl md:text-6xl lg:text-7xl tracking-tight font-semibold">
        <div className="leading-[1.15]">
          ...
          >
            Tutkumu ve becerilerimi dijital ürünler ve deneyimler oluşturmak için kullanıyorum.
          </span>
          <span
            className="introText inline-block"
            style={{ opacity: opacityForBlock(progress, 2) }}
          >
            Son teknoloji ürünü, piksel açısından mükemmel kullanıcı arayüzü ve sezgisel olarak uygulanan kullanıcı deneyimi konusunda tutkuluyum.
          </span>
        </div>
      </div>
    </div>
