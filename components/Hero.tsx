...
export default function Hero(): ReactElement {
  ...
  return (
    <div>
      ...
      Merhaba ben Mustafa Babayev, yazılım mühendisi ve girişimciyim , proje oluşturmayı seviyorum.
      </h1>
      <motion.div
            ...
            <div className="-mt-36">
              <div ref={ref} className="flex flex-col space-y-2 cursor-default">
                ...
                <FadeRight duration={0.5} delay={0.8}>
                  ...
                  >
                    Hakkımda daha fazlasını oku &rarr;
                  </Link>
                </FadeRight>
              </div>
