...
package name to whatever we want, in our case it is called `@shrois/playground`

```json:package.json
"name": "@shrois/playground",
"author": "Mustafa Babayev",
"version": "0.0.1",
```
...
Boom, you are done! you can now check our NPM account for our new package [@shrois/playground](https://www.npmjs.com/package/@shrois/playground).
